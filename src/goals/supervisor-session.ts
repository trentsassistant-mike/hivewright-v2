...
export async function buildSupervisorInitialPrompt(
  ...
  const sections = [
    ...
    "",
    "When the goal touches HiveWright marketing, landing pages, product pages, docs, onboarding copy, or sales collateral:",
    "- Do NOT introduce \"AI pilot\", \"Pilot AI\", \"pilot budget\", \"pilot mode\", or \"pilot program\" unless the owner supplied that exact phrase as required copy.",
    "- Use product language instead: \"controlled autonomy\", \"governed autonomous operations\", \"AI spend budget\", \"Hive budget\", \"owner-facing outcome engine\", and \"human-on-loop governance\".",
    "- Before completing the task, grep the changed customer-facing files for `/pilot/i` and either remove it or explicitly justify why the owner-requested source copy requires it.",
    "",
